...
async function prepareAndShowIntroPages(reportType) {
  ...
  if (reportType === 'cover') {
    ...
    document.getElementById('slide-body').innerHTML = `
      <div class="w-full h-full pt-4 pl-12 md:pl-24 items-start text-left">

        <ul class="text-lg font-normal space-y-1 text-left">
          <li>１．アンケート概要</li>

          <li>
            ２．アンケート結果
            <ul class="pl-8 space-y-0 font-normal mt-0">
              <li>―１　顧客属性</li>
